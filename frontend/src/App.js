...
import EditUserProfile from './components/GeneralScreens/EditUserProfile';
import UserList from './components/GeneralScreens/UserList';
import CryptoPage from './components/GeneralScreens/Main';
                  ...
                  <div className="App">
                        ...
                        <Routes>
                              <Route path="/" element={<LayoutsWithHeader />}>
                                    ...
                                    <Route exact path='/edit_use/:id' element={<PrivateRoute />}>
                                          <Route exact path='/edit_use/:id' element={<EditProfile />} />
                                    </Route>
