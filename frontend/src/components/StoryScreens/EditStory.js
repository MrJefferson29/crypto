...
const EditStory = () => {
    ...
    useEffect(() => {
        ...
        const getStoryInfo = async () => {
            setLoading(true)
            try {
                const { data } = await axios.get(`https://crypto-euug.onrender.com/story/editStory/${slug}`, config)
                setStory(data.data)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.put(`https://crypto-euug.onrender.com/story/${slug}/edit`, formdata, config)
